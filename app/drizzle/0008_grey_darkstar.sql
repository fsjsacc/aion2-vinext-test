...
CREATE TABLE `__new_analytics_daily` (
	...
	CONSTRAINT "analytics_daily_surface_check" CHECK("__new_analytics_daily"."surface" in ('unknown', 'home', 'home-hero', 'home-core-entry', 'home-directory', 'faction-gate', 'content-hub', 'content-detail', 'map-seo', 'interactive-map', 'daily-checklist', 'class-finder', 'material-calculator', 'correction-report', 'not-found')),
...
CREATE TABLE `__new_analytics_journey_events` (
	...
	CONSTRAINT "analytics_journey_events_surface_check" CHECK("__new_analytics_journey_events"."surface" in ('unknown', 'home', 'home-hero', 'home-core-entry', 'home-directory', 'faction-gate', 'content-hub', 'content-detail', 'map-seo', 'interactive-map', 'daily-checklist', 'class-finder', 'material-calculator', 'correction-report', 'not-found')),
